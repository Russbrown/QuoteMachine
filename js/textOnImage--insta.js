...
$(document).ready(function () {
    ...
    function drawCanvas(){
        ...
        if (backgroundImg.src == "") {
            ...
            context.drawImage(backgroundImg, imgPositionX, imgPositionY, imgWidth, imgHeight); // draw the image if its already there

            $(backgroundImg).on('load', function(){ // draw it after load if its new
                context.drawImage(backgroundImg, imgPositionX, imgPositionY, imgWidth, imgHeight);
                drawCanvas();
            });
